...
Form Validation is a process by which we check fields on a form (eg: name, age, gender) meet certain requirements eg. Length, is required etc.

1. In 1-2 sentences, define end to end testing.
End to end testing is the process of 
